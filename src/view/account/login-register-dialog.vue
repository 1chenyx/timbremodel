      ...
      <el-form :model="form" label-position="top" ref="form">
        ...
        <el-form-item label="第三方账号登录" class="oauth">
          ...
          <a href="javascript:void(0);" @click="() => signin('QQ')">
            <el-avatar class="margin-left-xs" title="qq登录" size="default">
...
export default {
  ...
  methods: {
    ...
    signin(provider) {
      ...
      console.log(`${process.env.VUE_APP_BASE_URL}cms/oauth2/signin?provider=${provider}&redirectUrl=${process.env.VUE_APP_CURRENT_URL}`)
      window.open(
