    ...
    <div>
        <el-row class="row-bg" :gutter="20">
            ...
            <el-col :span="24" class="margin-bottom-xs">
                ...
                <div>
                    <el-input v-model="model_input" placeholder="请输入查询标题" @change="infiniteHandler(currentState, true)"></el-input>
                </div>
            </el-col>
            <el-col :xs="24" :md="17">
                    ...
                    <el-card :body-style="{ 'padding-bottom': '10px', 'padding-top': '10px' }" shadow="never"
                        ...
                        <template #header>
                            <div class="card-header">
                                <span class="lin-title">分享你的模型</span>
                            </div>
                        </template>
                        <div>
                            ...
                            <el-button type="primary" plain @click="openEditorDialog">
                                <el-icon class="el-icon--left">  
                                    <Edit />
                                </el-icon>
                                上传模型
        ...
        <editor-dialog ref="editorDialog" editor="1" :id="0" content="defalut" title="">
        </editor-dialog>
    </div>
</template>
...
import EditorDialog from '../article/editor-dialog'
export default {
    name: 'HomeIndex',
    components: { ArticleList, InfiniteLoading, HotTagCard, NovicesCard, EditorDialog },
    data() {
        return {
            count: 20,
            dataSource: [],
            ...
            url: 'http://file.timbremodel.com/config/qqgroup.jpg',
            model_input: '',
            currentState: ''
        }
    },
    ...
    methods: {
        ...
        async infiniteHandler($state, isInput = false) {
            this.currentState = $state
            this.loading = true
            await this.getNavChannels()
            this.setPaginationParams()
            let res
            const currentPage = isInput ? 0 : this.pagination.currentPage
