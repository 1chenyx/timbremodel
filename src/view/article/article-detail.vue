        ...
        <el-col :xl="18" :lg="18" :md="24" :sm="24" :xs="24">
          <el-card class="box-card" shadow="never">
            ...
            <div class="audio-preview">
              <audio controls class="preview-audio" v-if="model.audio_path">
                <source :src="model.audio_path" key="alnoe" type="audio/mpeg">
              </audio>
              <div id="preview"  @click="handlePreview($event)"></div>
              <!-- <div class="preview">
              </div> -->
            </div>
            <div class="tag-box top20">
              <h3 class="tag-title">下载</h3>
              <div class="download">
                 <span>地址：</span>
                 <span>{{ model.download_path }}</span>
              </div>
              <div class="download">
                 <span>密码：</span>
                 <span>{{ model.download_pass }}</span>
              </div>
            </div>
            <div id="outline"></div>
          ...
          <div id="comment-list" class="margin-bottom-xs">
            <comment-list :subject_id="id" :subject_type="1" :resp_user_id="model.create_user_id"
...
.audio-preview {
  ...
  align-items: center;
  flex-wrap: nowrap;
  padding: 0px 12px 20px calc(1rem + 6px) !important;
  .preview-audio {
    margin-right: 10px;
  }
}
#preview :deep {
  color: #24292e;
  // padding: 0px 12px 20px 1rem !important;
  line-height: unset;
  padding-right: 10px;
  ul li,
  a,
